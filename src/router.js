...
export function createConfiguredRouter() {
  ...
  // Search Routes (Aliases: /search, /search/youtube, /ytsearch, /api/search, /api/search/youtube, /api/ytsearch)
  ...
  // Audio Routes (Aliases: /audio, /ytaudio, /downloader/ytaudio, /downloader/audio, /api/audio, /api/ytaudio, etc.)
  ...
  // Video Routes (Aliases: /video, /ytvideo, /downloader/ytvideo, /downloader/video, /api/video, etc.)
